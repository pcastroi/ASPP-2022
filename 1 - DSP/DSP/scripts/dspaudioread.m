function [data,fsHz,nBits] = dspaudioread(fName,fsRefHz,range)
%dspaudioread   Read audio files using either audioread or wavread.
...
% 
%USAGE
%   [data,fsHz,nBits] = dspaudioread(fName)
%   [data,fsHz,nBits] = dspaudioread(fName,fsRefHz,range)
%   [data,fsHz,nBits] = dspaudioread(fName,'info')
% 
%INPUT ARGUMENTS
