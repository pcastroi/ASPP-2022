function smpldemo(h_fig);
% SMPLDEMO      Demonstration of different effects while sampling
% 
...
if str2double(strVersion(1:4)) < 2014; %use figure handle acc. to release version
    smplslide(h_fig,1);             % start with the first slide
else
    smplslide(h_fig.Number,1);      % start with the first slide
end
