function [gmmFinal,logEM] = trainGMM_Netlab(data,labels,K,nIter,thresEM,cv,reg)
%trainGMM_Netlab   Train a Gaussian mixture model (GMM) classifier
...
if nargin < 7 || isempty(reg);     reg     = 0;      end
...
optEM(5)  = reg;      % Check covariance matrices 
