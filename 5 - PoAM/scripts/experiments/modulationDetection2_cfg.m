...
def=struct(...
'expname','modulationDetection2',		...		% name of experiment   
...
'exppar1',[10],...	% vector containing experimental parameters for which the exp is performed
'exppar1unit','Hz',		...		% unit of experimental parameter
'repeatnum',2,				...		% number of repetitions of the experiment
...
%% for the second experiment with actual test subjects uncomment the following line:
% def.exppar1 = [5 50];
% 'exppar1',[3 5 7 10 15 20 30 50 70 100],...	% vector containing experimental parameters for which the exp is performed
