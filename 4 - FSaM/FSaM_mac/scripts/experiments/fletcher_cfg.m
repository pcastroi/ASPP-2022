...
% $Revision: 0.92 beta$  $Date: 09-03-2004 11:13 $

def=struct(...
'expname','fletcher',		...		% name of experiment   
...
'exppar1',[50 100 200 400 800 1600],	...		% vector containing experimental parameters (here the masker bandwidth rel CF) for which the exp is performed
'exppar1unit','BW/Hz',		...		% unit of experimental parameter
