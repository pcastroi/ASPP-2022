...
tref1 = bpnoise( def.intervallen, set.lcf, set.ucf, def.samplerate) .* set.window;
tref2 = bpnoise( def.intervallen, set.lcf, set.ucf, def.samplerate) .* set.window;
tuser = bpnoise( def.intervallen, set.lcf, set.ucf, def.samplerate) .* set.window;
