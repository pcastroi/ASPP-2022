...
set.lcf = set.midfreq - work.exppar1/2;         % lower cutoff freq of masker noise;
set.ucf = set.midfreq + work.exppar1/2; 	% upper cutoff freq of masker noise;

currbw = work.exppar1;				% current relative bw
