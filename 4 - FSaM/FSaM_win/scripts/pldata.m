...
%               figure % new figure for new experiment
    ...
    % some labeling
    knownexps = {'tint','notchednoise', ...
                 'fletcher','intjnd', ...
                 'ildjnd','bmld', ...
                 'bbtmtf','titrade'};
    xlabels = {'duration [ms]','relative notch width (g)', ...
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [LEGH,OBJH,OUTH,OUTM] = legend(toput,towrite,'Location','Best');
