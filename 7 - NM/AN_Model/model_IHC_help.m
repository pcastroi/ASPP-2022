% model_IHC - Bruce, Erfani & Zilany (2018) Auditory Nerve Model
%
%     vihc = model_IHC(pin,CF,nrep,dt,reptime,cohc,cihc,species);
%
...
% For example,
%
%    vihc = model_IHC(pin,1e3,10,1/100e3,0.2,1,1,2); **requires 8 input arguments
%
