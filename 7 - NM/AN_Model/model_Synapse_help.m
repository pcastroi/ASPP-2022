% model_Synapse - Bruce, Erfani & Zilany (2018) Auditory Nerve Model
%
%     psth = model_Synapse(vihc,CF,nrep,dt,noiseType,implnt,spont,tabs,trel);
%
...
% For example,
%
%    psth = model_Synapse(vihc,1e3,10,1/100e3,1,0,50,0.7,0.6); **requires 9 input arguments
%
...
%
%     [psth,meanrate,varrate,synout,trd_vector,trel_vector] = model_Synapse(vihc,CF,nrep,dt,noiseType,implnt,spont,tabs,trel);
%
